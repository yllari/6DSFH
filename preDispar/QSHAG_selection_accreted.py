...
if __name__ == "__main__":
    ...
    pre_dispar = PreDisPar(in_file, sel_type)
    ...
    out_full.export_hdf5(f'{pre_dispar.sel_structure}_{selection_type}_full.hdf5', progress=True)
    out_qshag.export_hdf5(f'{pre_dispar.sel_structure}_{selection_type}_qshag.hdf5', progress=True)
